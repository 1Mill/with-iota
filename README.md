...
![Image communicating lifecycle](./images/lifecycle.jpg)

![Image communicating that all mutations are applied first followed by all rapids cloudevents](/images/commit-order.jpg)
